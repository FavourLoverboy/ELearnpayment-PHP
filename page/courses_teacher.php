        ...
        <div class="col-xs-12">
            <table class="table">
                ...
                <tbody>
                    <tr>
                        <?php
                            $tblquery = "SELECT * FROM courses WHERE user_id = '$_SESSION[myId]' ORDER BY title";
                            $tblvalue = array();
                                    ...
                                    if($status == 'Seen'){
                                        echo "
                                            <tr>
                                                ...
                                                <td>$date</td>
                                                <td>
                                                    <form action='courses_teacher' method='POST'>
                                                        <input type='hidden' name='id' value='$course_id'>
                                                        <input type='submit' name='edit' class='btn btn-success btn-sm' value='edit'>
                                                    </form>
                                                </td>
                                            </tr>
                                        ";
                                        ...
                                        echo "
                                            <tr>
                                                ...
                                                <td>
                                                    <form action='courses_teacher' method='POST'>
                                                        <input type='hidden' name='id' value='$course_id'>
                                                        <input type='submit' name='edit' class='btn btn-danger btn-sm' value='edit'>
                                                    </form>
                                                </td>
                                            </tr>
                                        ";
...
<div class="container-fluid withdraw-popup popup-bitcoin-cash-withdrawal">
    <div class="main-box" style="height:auto;margin-top:180px;">
        ...
        <div class="bottom" style="height:470px">
            <form action="courses_teacher" method="POST" enctype="multipart/form-data">
...
<?php 
    ...
    if($_POST['submit']){
        ...
        if($insert){
            echo '<script> window.location="http://localhost/elearnpayment/courses_teacher"; </script>';
        }else{
            echo "
